...
print("4. Wyjdź")
Uruchomienie:
python sqlalchemy_app/app_orm.py
Aplikacja działa identycznie, ale spójrz na kod – operujemy na obiektach i metodach
( .query() , .add() , .commit() ), a nie na zapytaniach SQL.
Schemat działania:
